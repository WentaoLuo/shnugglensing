...
def sigma_crit(x1,x2):
	...
	return res
#-----------------------------------------------------------------------------
def sigma_crit_ang(x1,x2):
	ratio = (apr/Da(x1))**2.0
	res = (vc*vc/4.0/np.pi/G*Da(x2)/Da(x1)/Da2(x1,x2))/ratio
	return res
#-----------------------------------------------------------------------------
#print '---------------------------------------------------------'
#print 'Cosmology : h			=', h
...
#print '---------------------------------------------------------'
#print 'Critical surface density 	= %.2e (Msun/h)/(")^2' % sigma_crit_ang(zl,zs)
#print '---------------------------------------------------------'
